...
<body>
    ...
    <div class="container box-shadow">
        ...
        <br />
        <button class="btn btn-success" onclick="add_pbucket()"><i class="glyphicon glyphicon-plus"></i> Add New</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('pbucket/ajax_list')?>",
            "type": "POST"
        },
...
function edit_pbucket(ProgramBucketId)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals    
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('pbucket/ajax_edit/')?>/" + ProgramBucketId,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('pbucket/ajax_add')?>";
    } else {
        url = "<?php echo site_url('pbucket/ajax_update')?>";
    }
...
function save_del()
{
    ...
    $('#btnSave').attr('disabled',true); //set button disable 
    var url;
        url = "<?php echo site_url('pbucket/ajax_update_del')?>";
